...
class Message(models.Model):
    # el que envia el mensaje esta asociado a un perfil, por eso se usa el foreign key
    # colocamos null en on delete ya que si una persona borra su perfil queremos aun ver sus mensajes
